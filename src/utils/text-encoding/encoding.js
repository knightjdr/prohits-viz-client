...
/* This is JK's modified version of https://github.com/inexorabletash/text-encoding
** that removes unnecessary encodings. */
...
(function (global) {
  ...
  function indexShiftJISPointerFor(code_point) {
    ...
    shift_jis_index = shift_jis_index ||
      index('jis0208').map((code_point, pointer) => (inRange(pointer, 8272, 8835) ? null : code_point));
  ...
  if (Object.defineProperty) {
    ...
    Object.defineProperty(TextDecoder.prototype, 'encoding', {
      /** @this {TextDecoder} */
      get() { return this._encoding.name.toLowerCase(); },
    });
    ...
    Object.defineProperty(TextDecoder.prototype, 'fatal', {
      /** @this {TextDecoder} */
      get() { return this._error_mode === 'fatal'; },
    });
  ...
  TextDecoder.prototype.decode = function decode(input, options) {
    ...
    while (true) {
      ...
      if (result !== null) {
        if (Array.isArray(result)) { output.push(...result); } else { output.push(result); }
      }
